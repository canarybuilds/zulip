...
Each Feniks Chat account is associated with an email address. If your organization
...
Feniks Chat provides a number of configuration options to control who can create a new
...
You can restrict the ability to invite new users to join your Feniks Chat organization
